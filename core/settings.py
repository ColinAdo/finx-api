...
ALLOWED_HOSTS = os.getenv('DJANGO_ALLOWED_HOSTS', '.herokuapp.com, 127.0.0.1,localhost').split(',')
...
CORS_ALLOWED_ORIGINS = os.getenv(
    ...
    'http://localhost:3000, http://127.0.0.1:3000, https://finx-api-00ec7aa68e8b.herokuapp.com'
).split(',')
